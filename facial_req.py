...
workbook = openpyxl.load_workbook(r'C:\Users\M Jaganmohan Rao\Desktop\face attendence\attendance.xlsx')
...
while True:
    ...
    for encoding in encodings:
        ...
        if True in matches:
            ...
            if currentname != name:
                ...
                # Check if 24 hours have passed since the face was last recorded
                if (
                    ...
                    # Update the last recorded time for the face
    ...
    fps.update()
    workbook.save(r'C:\Users\M Jaganmohan Rao\Desktop\face attendence\attendance.xlsx')
